...
<body>
    ...
    <!-- SECTION -->
        ...
        <!-- container -->
           ...
           <h1>Đơn hàng và Trả hàng</h1>
           <h4>1.Điều khoản trả lại</h4>
           <p>Khách hàng cần kiểm tra tình trạng hàng hóa và có thể đổi / trả hàng trong các trường hợp sau:</p>
           <p>Các mặt hàng không phù hợp với loại hoặc mô hình trong đơn hàng đã đặt hoặc trên trang web tại thời điểm đặt hàng.</p>
           <p>Không đủ số lượng, không đủ bộ như trong đơn hàng.</p>
           <p>Sản phẩm phải không có nhãn mác, trong tình trạng mới / chưa qua sử dụng.</p>
           <p>Khách hàng có trách nhiệm xuất trình các giấy tờ liên quan chứng minh những thiếu sót nêu trên để hoàn thiện đổi / trả hàng. </p>
           <h4>2. Quy định về thời gian thông báo và gửi sản phẩm đổi trả</h4>
           <p>Thời gian thông báo trở lại: trong vòng 3 ngày & nbsp; kể từ thời điểm nhận hàng trong trường hợp sản phẩm bị thiếu phụ kiện, quà tặng hoặc bị hư hỏng.</p>
           <p>Thời gian giao sản phẩm: trong vòng 7 ngày kể từ ngày nhận được sản phẩm.</p>
           <p>Địa điểm đổi trả sản phẩm: Quý khách hàng có thể mang hàng trực tiếp đến văn phòng / cửa hàng của chúng tôi hoặc gửi qua đường bưu điện.</p>
           <p>Trong trường hợp có ý kiến ​​đóng góp / khiếu nại liên quan đến chất lượng sản phẩm, vui lòng liên hệ fanpage của Chúng tôi. Xin chân thành cảm ơn.</p>
           </div>
