	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				%>
				<form action="AddUserFB" class="login100-form validate-form" method="post">
					<div class="wrap-input100 validate-input m-b-26">
						<span class="label-input100">ID</span>
						<input  class="input100" type="text" name="idd" value="<%=obj_Profile_Bean.getId() %>" disabled>
						<input class="input" name="id" style="display: none" value="<%=obj_Profile_Bean.getId()%>" type="text">
					</div>
					<div class="wrap-input100 validate-input m-b-26">
						<span class="label-input100">Username</span>
						<input class="input100" type="text" name="username" value="<%=obj_Profile_Bean.getUser_name() %>" disabled>
						<input class="input" name="username" style="display: none" value="<%=obj_Profile_Bean.getUser_name()%>" type="text">
					</div>

					<div class="wrap-input100 validate-input m-b-18" >
						<span class="label-input100">Email</span>
						<input class="input100" type="text" name="email" value="<%=obj_Profile_Bean.getEmail() %>" disabled>
						<input class="input" name="email" style="display: none" value="<%=obj_Profile_Bean.getEmail()%>" type="text">
					</div>
